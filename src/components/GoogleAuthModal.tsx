        ...
        <div style={{ padding: '22px 24px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '18px' }}>
          ...
          >
            ...
            <div>
              ...
              {/* Custom Dropdown Seletor de Modelo Gemini */}
              <div ref={modelDropdownRef} style={{ position: 'relative' }}>
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    outline: 'none',
                    boxShadow: isModelDropdownOpen ? '0 0 0 3px rgba(99, 102, 241, 0.15)' : 'none',
                    transition: 'all 0.2s ease',
                    textAlign: 'left',
                  }}
                >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{ fontWeight: 600, color: 'var(--text-primary)' }}>
                          {availableModels.find((m) => m.id === selectedModel)?.displayName.split('(')[0].trim() || selectedModel}
                        </span>
                      ...
                      <span style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>
                        {selectedModel.includes('pro') ? 'Raciocínio Analítico Avançado' : 'Nova Geração Ultra-Rápida'}
                      </span>
                    </div>
                  </div>
                      ...
                      return (
                        ...
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 }}>
                            ...
                            <div>
                              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <span style={{ fontWeight: isSelected ? 700 : 600, color: 'var(--text-primary)' }}>
                                  {cleanTitle}
                                </span>
                                {isRecommended && (
                                  <span
